...
2026-08-26：[ADR-0034](0034-cli-composes-workspace-fact.md) 将工作区选择、目录与提示词事实完全留在 CLI，Session 不再创建工作区。正数守卫仍位于身份生成、工具注册和 Turn 接纳之前；原“失败后不创建目录”是当时实现的额外证据，不再是 core contract。本决策的双入口验证仍然有效。
